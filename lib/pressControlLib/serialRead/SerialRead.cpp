...
bool waitForChar(const char *descr, char chr) {
    const char appo[] = {chr}; // trasforma in string
    Serial.printf(descr);
...
// // # wait for 'chr' input
// // #################################################
// char getInputOutputPin() {
//     uint8_t count = readSerialData("io0123456789", 3); // max 3 char, es,: i12
//         return true;
//     }
//     if (count > 0) {
//         if (receivedChars[0] == 'i' || receivedChars[0] == 'o') {
//         return receivedChars[0];
//     }
//     else {
//         return 0;
